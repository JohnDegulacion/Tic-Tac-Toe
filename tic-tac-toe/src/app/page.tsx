...
export default function OnePieceTicTacToe() {
      ...
      return (
        <div className="relative flex items-center justify-center w-16 h-16">
          <Image
            ...
            width={64}
            height={64}
            className="animate-bounce rounded-full object-cover w-full h-full"
  ...
  console.log("Game State:", {
    ...
    totalWins,
    isAnimating,
    board: board.filter((cell) => cell !== null).length,
  });
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-[10px] max-w-[2000px] mx-auto overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        />
        {/* Overlay for better readability and to hide any watermarks */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-black/40"></div>
        {/* Additional overlay to mask potential watermarks */}
